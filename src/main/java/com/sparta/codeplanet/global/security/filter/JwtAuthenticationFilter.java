...
import com.sparta.codeplanet.domain.user.dto.LoginRequestDto;
import com.sparta.codeplanet.domain.user.UserRefreshToken;
import com.sparta.codeplanet.domain.user.repository.UserRefreshTokenRepository;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, Authentication auth)
        ...
        com.sparta.codeplanet.domain.user.User user = userDetails.getUser();
